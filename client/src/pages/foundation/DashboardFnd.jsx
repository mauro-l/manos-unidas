...
function DashboardFnd() {
  ...
  if (!loading)
    return (
      <div>
        <Banner>
          Crea actividades para que los voluntarios se inscriban en tus
          propuestas
        </Banner>
        <div className="container px-4 pb-10 space-y-6 lg:mx-auto">
          {/* <IncompleteDashboard /> */}
          <div className="flex flex-col items-center space-y-6 lg:space-y-0 lg:flex-row-reverse lg:items-start lg:gap-12 lg:-mt-8 bg-neutral-content lg:p-12 lg:rounded-lg">
            <Link
            ...
            <div className="space-y-4">
              <TitleDoubleXL>Voluntariados creados</TitleDoubleXL>
