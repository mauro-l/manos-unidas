          ...
          <div className="lg:px-12">
            ...
            <div className="flex flex-col w-full gap-4 lg:flex-row">
              ...
              <div className="relative w-full">
                <button
                  className="mb-10 btn btn-ghost bg-primary text-primary-content w-full border-base-300 "
                ...
                {showApproveAlert && (
                  <div className="fixed bottom-36 left-0 right-0 z-50 flex p-4 mx-4 bg-success rounded-lg items-center gap-4 transition-all duration-300 ease-in-out">
                    <div>
              ...
              <div className="relative w-full ">
                <button
                  className="mb-10 btn btn-ghost w-full border-base-300 "
